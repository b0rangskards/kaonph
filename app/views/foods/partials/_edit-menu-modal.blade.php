<div class="modal fade custom-modal" id="modal_update_menu" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h3 class="modal-title">Update Menu<span></span></h3>

      </div>
      <div class="modal-body">

      {{Form::open(['route'     =>      ['foods.updatemenu', Request::segment(2)],
                    ...
                    <div class="fileupload fileinput-new margin-bottom-10" data-provides="fileinput">
                        {{--<div class="col-md-12">--}}
                          <div class="fileinput-new thumbnail" data-trigger="fileinput">
                                <img src="{{asset('/images/no_img.png')}}" id="edit-menu-preview-food" alt="" style="height: 160px;"/>
                                </div>
